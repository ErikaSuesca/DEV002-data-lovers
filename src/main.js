...
//Procedimiento para Filtrar por tipo a través de un evento cambio sobre el menú tipo

document.getElementById("tipoPokemon").addEventListener("change", () => {
  // Obtiene el tipo de pokemon desde el menú
  const seleccionTipoPokemon = document.getElementById("tipoPokemon").value;
